...
and only seven of the rows below have the second one enforced: `bounds-transformed-or`,
...
`tests/oracle/anim3d.cases`, and `ray-bounds-parallel-on-face` two and `pick-origin-inside-bounds` one in `tests/oracle/ray3d.cases`,
