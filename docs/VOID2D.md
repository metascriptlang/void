...
- `tests/golden/d3d11/` — **37 scenes** at P0, generated from that renderer, defects and all; **48** after P1 turned the filter rows on and added the scenes its review asked for.
