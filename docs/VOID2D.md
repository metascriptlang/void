...
`TextLayout` copy per selection row per frame that the design pass found (`39eaafa`).

**P4's `present`**, the P5 baseline: `scripts/bench-ab.sh out/snap/4d357f7 . 8`, both trees built
with `--release` on BUILD `598ca62e`, the P4 head `9f28fb8` (tree `2497f5d`) against the P3.5 head
